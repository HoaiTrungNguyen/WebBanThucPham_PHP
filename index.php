                ...
                <div class="container">
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-3">
                            <div class="header-phone text-end"><i class="icon-phone">+84 0000 0000</i></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-4 col-md-5">
                        <div class="footer__about1">
                            <ul class="footer__address">
                                <li class="footer__address-item"><i class="fa fa-home"></i>Địa chỉ: Hutech, Việt Nam</li>
                                <li class="footer__address-item"><i class="fa fa-phone-alt"></i>+84 0000 0000</li>
                    ...
                    <div class="col-lg-4 col-md-5">
                        <div class="footer__menu">
                            ...
                            <ul class="footer__nav">
                                <li class="footer__list">Thứ 2 - Thứ 6: 5h - 22h</li>
                                <li class="footer__list">Thứ 7: 5h - 20h</li>
